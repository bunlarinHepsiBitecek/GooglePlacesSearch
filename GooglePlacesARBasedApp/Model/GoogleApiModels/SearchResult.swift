...
class SearchResult: Codable {
    ...
    init(htmlAttributions: [JSONAny], nextPageToken: String, results: [GoogleSearchResult], status: String) {
...
class GoogleSearchResult: Codable {
    ...
    init(geometry: Geometry, icon: String, id: String, name: String, openingHours: OpeningHours?, photos: [Photo]?, placeID: String, plusCode: PlusCode, priceLevel: Int?, rating: Double?, reference: String, userRatingsTotal: Int?, vicinity: String) {
